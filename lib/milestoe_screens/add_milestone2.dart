...
import '../milestone_provider/milestoneProvider.dart';
...
class MileStone2 extends StatefulWidget {
  const MileStone2({super.key});

  @override
  State<MileStone2> createState() => _MileStone2State();
}

class _MileStone2State extends State<MileStone2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          const CustomDrawer(60, 1.2),
          const VerticalDivider(width: 1, thickness: 1),
          Expanded(
            child: Scaffold(
              appBar: AppBar(
                title: const Text("Project Milestone", style: TextStyle(color: Colors.black)),
                centerTitle: true,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          const Padding(
                                            ...
                                            child: Text("Milestone", style: TextStyle(fontWeight: FontWeight.bold),),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.only(top: 10, bottom: 10),
                                            child: Container(color: Colors.black, height: 1, width: 500,),
                                          ),
                                          Padding(
